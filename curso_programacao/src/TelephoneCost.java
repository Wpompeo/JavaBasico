	...
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in, "UTF-8")) {
			...
			case 1:
				...
				if (min == 100 || min <= 100) {
					System.out
							.println("Você não excedeu os minutos do seu plano,o valor da sua conta é R$ 50,00 Reais.");
				}
				if (min > 100) {
					double minExced = (min - 100);
					double costExtra = (minExtraOne * minExced) + planoOne;
					System.out.printf("Você excedeu %.2f minutos do seu plano, sua conta será de R$ %.2f Reais: ",
							minExced, costExtra);
				}
				break;
			...
			case 2:
				...
				if (min == 150 || min <= 150) {
					System.out.println(
							"Você não excedeu os minutos do seu plano, o valor de sua conta é R$ 100,00 Reais.");
				} else {
